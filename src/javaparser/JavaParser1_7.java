...
public class JavaParser1_7
  ...
  // Added lookahead but not sure why it made it work...but it is necessary for
  // proper behaviour
  ...
  final public void NonWildcardTypeArgumentsOrDiamond() throws ParseException {
    ...
    NonWildcardTypeArgumentsOrDiamond jjtn000 = new NonWildcardTypeArgumentsOrDiamond(
        JJTNONWILDCARDTYPEARGUMENTSORDIAMOND);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);
    jjtn000.jjtSetFirstToken(getToken(1));
    try {
  ...
  final public void VoidInterfaceMethodDeclaratorRest() throws ParseException {
    ...
    VoidInterfaceMethodDeclaratorRest jjtn000 = new VoidInterfaceMethodDeclaratorRest(
        JJTVOIDINTERFACEMETHODDECLARATORREST);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);
    jjtn000.jjtSetFirstToken(getToken(1));
    try {
  ...
  // Slightly changed because this was defined as left recursive in intial
  // grammar! Odd since it defines it as LL(k)
  ...
  final public void LocalVariableDeclarationStatement() throws ParseException {
    ...
    LocalVariableDeclarationStatement jjtn000 = new LocalVariableDeclarationStatement(
        JJTLOCALVARIABLEDECLARATIONSTATEMENT);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);
    jjtn000.jjtSetFirstToken(getToken(1));
    try {
  ...
  // Definitely not a mistake, but can't tell semantic yet! Construct found in
  // OpenJDK
  ...
  // Breaking the original rule to follow the classic expression pattern. Oddly,
  // the original spec of the grammar shouldn't allow a = b = c, but compilers
  ...
  // Written loc cit as in the spec, but I believe it is inconsistent; changed due
  // to epsilon production, but spec is clearly inconsistent
  ...
  final public void AnnotationTypeElementDeclarations() throws ParseException {
    ...
    AnnotationTypeElementDeclarations jjtn000 = new AnnotationTypeElementDeclarations(
        JJTANNOTATIONTYPEELEMENTDECLARATIONS);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);
    jjtn000.jjtSetFirstToken(getToken(1));
    try {
  ...
  final public void AnnotationTypeElementDeclaration() throws ParseException {
    ...
    AnnotationTypeElementDeclaration jjtn000 = new AnnotationTypeElementDeclaration(
        JJTANNOTATIONTYPEELEMENTDECLARATION);
    boolean jjtc000 = true;
    jjtree.openNodeScope(jjtn000);
    jjtn000.jjtSetFirstToken(getToken(1));
    try {
  ...
  private boolean jj_3_224() {
    if (jj_scan_token(LOGICALEQUAL))
      return true;
    return false;
  }

  private boolean jj_3_223() {
    if (jj_scan_token(BINARYAND))
      return true;
    return false;
  }

  private boolean jj_3_222() {
    if (jj_scan_token(BINARYXOR))
      return true;
    return false;
  }
  ...
  private boolean jj_3_212() {
    if (jj_scan_token(TRIPLESHIFTEQUAL))
      return true;
    return false;
  }
  ...
  private boolean jj_3_211() {
    if (jj_scan_token(RBINARYSHIFTEQUAL))
      return true;
    return false;
  }

  private boolean jj_3_210() {
    if (jj_scan_token(LBINARYSHIFTEQUAL))
      return true;
    return false;
  }

  private boolean jj_3_209() {
    if (jj_scan_token(MODULOEQUAL))
      return true;
    return false;
  }
  ...
  private boolean jj_3_208() {
    if (jj_scan_token(BINARYXOREQUAL))
      return true;
    return false;
  }

  private boolean jj_3_207() {
    if (jj_scan_token(BINARYOREQUAL))
      return true;
    return false;
  }
  ...
  private boolean jj_3_206() {
    if (jj_scan_token(BINARYANDEQUAL))
      return true;
    return false;
  }
